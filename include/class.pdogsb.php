...
echo getenv('DB_DRIVER');*/	
       ...
       /*private static $serveur=  getenv('DB_DRIVER')+":host="+getenv('DB_HOST');
      	private static $bdd='dbname='+ getenv('DB_NAME');
      	private static $user=getenv('DB_USERNAME');		
      	private static $mdp= getenv('DB_PASSWORD') ;	
		private static $monPdo;
		private static $monPdoGsb=null;*/
/**
